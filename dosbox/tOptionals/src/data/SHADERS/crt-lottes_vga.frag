...
#define hardScan -8.0//-8.0
#define hardPix -8.0//-3.0
#define warpX 0.005 //0.021, 0.007
#define warpY 0.005 //0.045, 0.021 
#define maskDark 0.75
#define maskLight 1.25
#define scaleInLinearGamma 1
#define shadowMask 3
#define brightboost 1.25
#define hardBloomScan -2.0//-1.8
#define hardBloomPix -2.0//-1.5
#define bloomAmount 0.25/16.0
#define shape 1.7 //2.0
